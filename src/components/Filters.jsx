...
const Filters = () => {
    ...
    return (
        <Form className='border-2 bg-base-200 px-8 py-4 grid gap-x-4 gap-y-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center'>
            {/*SEARCH */}
            ...
            {/*SHIPPING */}
            <FormCheckbox name='checkbox' label='free shipping' size='checkbox-sm' />
            {/*PRICE */}
